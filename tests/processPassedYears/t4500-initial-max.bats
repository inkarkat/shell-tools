...
@test "initial call passed just the first two and a later call the first four" {
    setDate 2015-03-05
    run processPassedYears --id ID --start-at 2012 --initial-first 2 --max-first 4 -- printf '[%s]-'
    [ $status -eq 0 ]
    [ "$output" = "[2012]-[2013]-" ]
...
@test "initial call passed just the last two and a later call the last four" {
    setDate 2015-03-05
    run processPassedYears --id ID --start-at 2012 --initial-last 2 --max-last 4 -- printf '[%s]-'
    [ $status -eq 0 ]
    [ "$output" = "[2013]-[2014]-" ]
...
@test "initial call passed just the first two and a later call the last four" {
    setDate 2015-03-05
    run processPassedYears --id ID --start-at 2012 --initial-first 2 --max-last 4 -- printf '[%s]-'
    [ $status -eq 0 ]
    [ "$output" = "[2012]-[2013]-" ]
    assert_last_year 2014
...
@test "initial call passed just the last two and a later call the first four" {
    setDate 2015-03-05
    run processPassedYears --id ID --start-at 2012 --initial-last 2 --max-first 4 -- printf '[%s]-'
    [ $status -eq 0 ]
    [ "$output" = "[2013]-[2014]-" ]
    assert_last_year 2015
