...
@test "initial call with start three years prior passes all first 3 years" {
    setDate 2021-03-05
    run -0 processPassedYears --id ID --start-at 2018 --max-first 2 -- printf '[%s]-'
...
@test "subsequent call after six years passes first 2 years" {
    setDate 2015-03-05
    run -0 processPassedYears --id ID --start-at 2012 --max-first 2 -- printf '[%s]-'
    assert_output '[2012]-[2013]-[2014]-'
