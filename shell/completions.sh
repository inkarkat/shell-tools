...
completeAsCommand combinations commandlineToShellCommand \
    ...
    withAccessibleFile withAliasedCommand withCwdPrependedToOutput withDebug withDeltaCommand withDir withDiskUsageDelta withEphemeralFile withFallbackPath withFirstExistingFile withHome withLoggingTo \
